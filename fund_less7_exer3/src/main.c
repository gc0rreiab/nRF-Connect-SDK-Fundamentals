...
#define WORQ_THREAD_STACKSIZE 512
...
static K_THREAD_STACK_DEFINE(my_stack_area, WORQ_THREAD_STACKSIZE);

// Define queue structure
static struct k_work_q offload_work_q = {0};

/* function to emulate non-urgent work */
/* on 64MHz ARM Cortex-M4F processor this should take ~24ms (~1.6us per count) */
